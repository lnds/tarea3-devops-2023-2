...
class TestAsignarpelculasadirectorexistente():
  ...
  def test_asignarpelculasadirectorexistente(self):
    ...
    self.driver.find_element(By.ID, "description").send_keys("Pelicula de superHeroes")
    ...
    self.driver.find_element(By.ID, "description").send_keys("Segunda parte de trilogia de nolan")
