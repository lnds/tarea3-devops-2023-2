...
class TestAgregarpeliculasnolan():
  ...
  def test_agregarpeliculasnolan(self):
    ...
    self.driver.find_element(By.ID, "description").send_keys("volvio nolan")
    ...
    self.driver.find_element(By.ID, "title").click()
    self.driver.find_element(By.ID, "title").send_keys("nolan se va")
    self.driver.find_element(By.ID, "description").click()
    self.driver.find_element(By.ID, "description").send_keys(" se va nolan")
    self.driver.find_element(By.ID, "year").click()
