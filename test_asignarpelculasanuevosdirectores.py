...
class TestAsignarpelculasanuevosdirectores():
  ...
  def test_asignarpelculasanuevosdirectores(self):
    ...
    self.driver.find_element(By.ID, "description").send_keys("Pelicula de los 80")
    self.driver.find_element(By.ID, "year").click()
    self.driver.find_element(By.ID, "year").send_keys("1980")
    ...
    self.driver.find_element(By.ID, "description").send_keys("Pelicula de los 90, gore.")
    self.driver.find_element(By.ID, "year").click()
